...
namespace QLDSVHTC_Sang_Truong.formDesign
{
    public partial class formClasses : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("Danh sách lớp rỗng!", "Cảnh báo!", MessageBoxButtons.OK);
                return;
            }
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            if (lOPBindingSource.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Không thể thêm khi chưa hoàn thành thao tác trước", "Thông báo", MessageBoxButtons.OK);
                    return;
                }
            }
        ...
        private void btnDeleteSV_Click(object sender, EventArgs e)
        {
            if (svBds.Count == 0)
            {
                XtraMessageBox.Show("Danh sách sinh viên rỗng", "Cảnh báo!", MessageBoxButtons.OK);
                return;
            }
        ...
        private void gridView2_ValidatingEditor(object sender, DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
        {
            if(gridView2.FocusedColumn.FieldName == "MASV")
            {
                ...
                {
                    e.Valid = false;
                    e.ErrorText = "Mã sinh viên không thể rỗng";
                    //btnAddSV.Enabled = false;
                    MessageBox.Show(this, "Mã số sinh viên bị rỗng!", "Cảnh báo!", MessageBoxButtons.OK);
                }
            ...
            else if (gridView2.FocusedColumn.FieldName == "HO")
            {
                ...
                {
                    e.Valid = false;
                    e.ErrorText = "Họ sinh viên không thể rỗng";
            ...
            else if (gridView2.FocusedColumn.FieldName == "TEN")
            {
                ...
                {
                    e.Valid = false;
                    e.ErrorText = "Tên sinh viên không thể rỗng";
